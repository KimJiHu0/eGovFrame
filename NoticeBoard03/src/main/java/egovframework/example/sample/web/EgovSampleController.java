...
public class EgovSampleController {
	...
	public String selectSampleList(@ModelAttribute("searchVO") SampleDefaultVO searchVO, ModelMap model)
		...
		System.out.println("FirstRecordIndex : " + paginationInfo.getFirstRecordIndex());
		System.out.println("PageSize : " + paginationInfo.getPageSize());
		System.out.println("페이징 sql의 조건절에 사용되는 시작 rownum : " + paginationInfo.getFirstRecordIndex());
		System.out.println("페이징 sql의 조건절에 사용되는 마지막 rownum : " + paginationInfo.getLastRecordIndex());
		System.out.println("lastIndex : " + paginationInfo.getPageSize());
