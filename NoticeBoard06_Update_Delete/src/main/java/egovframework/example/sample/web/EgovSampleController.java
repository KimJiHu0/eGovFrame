...
public class EgovSampleController {
	...
	public String addSample(@ModelAttribute("searchVO") SampleDefaultVO searchVO, SampleVO sampleVO,
		...
		System.out.println("==========");
		System.out.println("sample id : " + sampleVO.getId());
		System.out.println("sample name : " + sampleVO.getName());
		System.out.println("sample user_yn : " + sampleVO.getUseYn());
		System.out.println("sample description : " + sampleVO.getDescription());
		System.out.println("sample reg_user : " + sampleVO.getRegUser());
		System.out.println("==========");
	...
	public String updateSampleView(@RequestParam("selectedId") int id,
			@ModelAttribute("searchVO") SampleDefaultVO searchVO, Model model) throws Exception {
		SampleVO sampleVO = new SampleVO();
		sampleVO.setId(id); // 받아온 id값을 sampleVO라는 변수의 ID값에 담아준다.
